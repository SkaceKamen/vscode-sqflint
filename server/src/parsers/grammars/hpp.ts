...
export let grammar: { ParserRules: Rule[], ParserStart: string } = {
    ...
    {"name": "main", "symbols": ["_", "ClassBody", "_", "main$ebnf$1"], "postprocess": function(d) { return d[1] }},
    ...
    {"name": "IncludeDef$ebnf$1", "symbols": []},
    {"name": "IncludeDef$ebnf$1", "symbols": [/[^\n]/, "IncludeDef$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "Number", "symbols": ["_number"], "postprocess": function(d) { return d[0] }},
    {"name": "Number", "symbols": ["Name"], "postprocess": function(d) { return d[0] }},
    {"name": "Number", "symbols": [{"literal":"("}, "_", "Number", "_", {"literal":")"}], "postprocess": function(d) { return "(" + d[2] + ")" }},
    {"name": "Number", "symbols": ["Number", "_", /[+\-\/%*]/, "_", "Number"], "postprocess": function(d) { return d[0] + d[2] + d[4] }},
    ...
    {"name": "_float$ebnf$1", "symbols": ["_int"], "postprocess": id},
    {"name": "_float$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "_float", "symbols": ["_float$ebnf$1", {"literal":"."}, "_posint"], "postprocess": function(d) {return (d[0] || '') + d[1] + d[2]; }},
    ...
    {"name": "_number$string$1", "symbols": [{"literal":"0"}, {"literal":"x"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "_number", "symbols": ["_number$string$1", "_int"], "postprocess": function(d) { return d[0] + d[1]; }},
    ...
    {"name": "_stringchar", "symbols": ["_stringchar$string$1"], "postprocess": function(d, l) { return { string: d[0], location: [l, l + 2] } }},
