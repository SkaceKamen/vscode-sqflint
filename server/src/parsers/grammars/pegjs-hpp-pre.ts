...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c6 = "#include",
      peg$c7 = peg$literalExpectation("#include", false),
  ...
  function peg$parseIncludeValue() {
    var s0, s1, s2, s3, s4;
